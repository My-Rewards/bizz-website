...
const LoginPage = () => {
  ...
  return (
    <div className="flex flex-1 justify-center items-center min-h-screen">
      <View className="flex flex-col gap-3 max-w-md w-full">
        ...
        <div className="flex bg-white flex-col p-6 px-8 gap-3 rounded-lg shadow-lg max-w-md w-full">
            <View>
            <form className="flex justify-center flex-col gap-4" onSubmit={(e)=>{handleSignUp(e)}}>
                ...
                <div className="flex flex-row gap-2 justify-center">
                    <div>
                        <p className="flex my-auto text-sm font-medium ml-1.5" style={{fontFamily:'Avenir Next'}}>First Name</p>
                        <input
                            value={giveName}
                    ...
                    <div>
                        <p className="flex my-auto text-sm font-medium ml-1.5"  style={{fontFamily:'Avenir Next'}}>Last Name</p>
                        <input
                            value={familyName}
                ...
                <div className="flex flex-col gap-1 justify-center">
                <p className="flex my-auto text-sm font-medium ml-1.5" style={{fontFamily:'Avenir Next'}}>Date of Birth</p>
                    <input
                        type="date"
                        value={dob}
                        onChange={(e) => setDob(e.target.value)}
                        required
                        className="px-3 py-1.5 rounded-lg border-1 flex-1"
                        style={{ outlineColor: color_pallete[1], outlineWidth:1, colorScheme:'light', fontFamily:'Avenir Next'}}
                    />
                </div>
                <div className="flex flex-col gap-1 justify-center">
                    <p className="flex my-auto text-sm font-medium ml-1.5"  style={{fontFamily:'Avenir Next'}}>Password</p>
                    <div className="flex self-center w-full border-1 rounded-lg">
                        <input
                ...
                <div className="flex flex-col gap-1 justify-center">
                    <p className="flex my-auto text-sm font-medium ml-1.5"  style={{fontFamily:'Avenir Next'}}>Confirm Password</p>
                    <div className="flex self-center w-full border-1 rounded-lg">
                        <input
                        type={showPassword ? "text" : "password"}
                        className="px-3 py-1.5 rounded-l-lg flex-1"
                ...
                <div className="flex w-full justify-around items-center">
                    <button 
                    className="flex text-white px-8 py-2 my-2 rounded-lg cursor-pointer"
